    ...
    public class InfoWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            try
            {
                ...
                GUILayout.Label("AntiCheat Pro v3.1.3", boldStyle);
                ...
                {
                    Application.OpenURL("https://assetstore.unity.com/packages/tools/utilities/anti-cheat-pro-117539");
                }
                ...
                {
                    Application.OpenURL("mailto:guardingpearsoftware@gmail.com?subject=AntiCheat_Pro");
                }
